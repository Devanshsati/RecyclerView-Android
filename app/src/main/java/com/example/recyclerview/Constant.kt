...
object Constant {
    fun getData(): ArrayList<RvModel>{
        return arrayListOf(
            RvModel(R.drawable.restaurant5, "Pumpkin Restaurant", "Dehradun, UK, India"),
            RvModel(R.drawable.restaurant1, "La Belle Époque", "Paris, France"),
            RvModel(R.drawable.restaurant2, "Il Gabbino", "Rome, Italy"),
            RvModel(R.drawable.restaurant3, "El Asador de Aranda", "Madrid, Spain"),
            RvModel(R.drawable.restaurant, "The Fat Duck", "Bray, England"),
            ...
            RvModel(R.drawable.restaurant4, "Sukiyabashi Jiro", "Tokyo, Japan"),
            ...
            RvModel(R.drawable.restaurant2, "Golden Spoon", "Delhi, DL, India"),
